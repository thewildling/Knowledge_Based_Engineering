...
class Analyzer:
    ...
    def __init__(self, filename, filepath):
        ...
        self.fileName = filename + str(
            random.randint(1, 1000000))  # To allow several sessions to run smoothly without collisions between "files"
    ...
    def createFEM(self, meshMaxVal, meshMinVal, material):
        ...
        femPart1.PolygonGeometryMgr.SetPolygonBodyResolutionOnFemBodies(
            NXOpen.CAE.PolygonGeometryManager.PolygonBodyResolutionType.Standard)
        ...
        bodies1[0] = body1
        femCreationOptions1.SetGeometryOptions(NXOpen.CAE.FemCreationOptions.UseBodiesOption.VisibleBodies, bodies1,
                                               femSynchronizeOptions1)
        femCreationOptions1.SetSolverOptions("NX NASTRAN", "Structural",
                                             NXOpen.CAE.BaseFemPart.AxisymAbstractionType.NotSet)
        ...
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("quad mesh overall edge size", meshMaxVal,
                                                                           unit1)
        ...
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("element size on cylinder height", "1",
                                                                           unit1)
        ...
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("surface mesh size variation", "50",
                                                                           NXOpen.Unit.Null)
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("volume mesh size variation", "50",
                                                                           NXOpen.Unit.Null)
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("internal mesh gradation", "1.05",
                                                                           NXOpen.Unit.Null)
        ...
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("small feature tolerance", "10",
                                                                           NXOpen.Unit.Null)
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("small feature value", meshMinVal,
                                                                           NXOpen.Unit.Null)
        ...
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("maximum exposed aspect ratio", "1000",
                                                                           NXOpen.Unit.Null)
        mesh3dTetBuilder1.PropertyTable.SetBooleanPropertyValue("control slender", False)
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("minimum aspect ratio", "0.01",
                                                                           NXOpen.Unit.Null)
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("maximum imprint dihedral angle", "120",
                                                                           unit2)
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("gradation rate", "10", NXOpen.Unit.Null)
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("smoothing distance factor", "3",
                                                                           NXOpen.Unit.Null)
        ...
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("quad mesh edge match tolerance", "0.02",
                                                                           NXOpen.Unit.Null)
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("quad mesh smoothness tolerance", "0.01",
                                                                           unit1)
        ...
        mesh3dTetBuilder1.PropertyTable.SetBaseScalarWithDataPropertyValue("quad mesh node coincidence tolerance",
                                                                           "0.0001", unit1)
    ...
    def defineSim(self):
        ...
        simSolution1 = simSimulation1.CreateSolution("NX NASTRAN", "Structural", "SESTATIC 101 - Single Constraint",
                                                     "Solution 1",
                                                     NXOpen.CAE.SimSimulation.AxisymAbstractionType.NotSet)
        propertyTable1 = simSolution1.PropertyTable
        propertyTable1.SetBooleanPropertyValue("Iterative Solver", True)
        caePart1 = workSimPart
        modelingObjectPropertyTable1 = caePart1.ModelingObjectPropertyTables.CreateModelingObjectPropertyTable(
            "Bulk Data Echo Request", "NX NASTRAN - Structural", "NX NASTRAN", "Bulk Data Echo Request1", 1)
        caePart2 = workSimPart
        modelingObjectPropertyTable2 = caePart2.ModelingObjectPropertyTables.CreateModelingObjectPropertyTable(
            "Structural Output Requests", "NX NASTRAN - Structural", "NX NASTRAN", "Structural Output Requests1", 2)
    ...
    def assignConstrain(self, body, face):
        ...
        component1 = workSimPart.ComponentAssembly.RootComponent.FindObject(
            "COMPONENT " + self.fileName + " 1")  # "_fem 1")
    ...
    def assignLoad(self, force, body, face, direction):
        ...
        direction1 = workSimPart.Directions.CreateDirection(origin1, vector1,
    ...
    def assignTorqueLoad(self, force, body, face):
        ...
        expression1 = workSimPart.Expressions.CreateSystemExpressionWithUnits(str(force), unit1)
        ...
        expression2 = workSimPart.Expressions.CreateSystemExpressionWithUnits(str(force), unit1)
    ...
    def solveSim(self):
        ...
        numsolutionssolved1, numsolutionsfailed1, numsolutionsskipped1 = theSimSolveManager.SolveChainOfSolutions(
            psolutions1, NXOpen.CAE.SimSolution.SolveOption.Solve,
...
""" 
Underneath is the code-part we would have implemented to check the stress.

    def checkStress(self): #Aluminium deforms at 228 MPa
        if self.getStress() > 290:
            return False
        else:
            return True
    ...
    def getStress(self):
        ...
        theSession.SetUndoMarkName(markId1, "Result Measure Manager Dialog")

        markId2 = theSession.SetUndoMark(NXOpen.Session.MarkVisibility.Visible, "New Result Measure")

        markId3 = theSession.SetUndoMark(NXOpen.Session.MarkVisibility.Invisible, "Start")

        theSession.SetUndoMarkName(markId3, "Result Measure Dialog")

        # ----------------------------------------------
        #   Dialog Begin Result Measure
        # ----------------------------------------------
        markId4 = theSession.SetUndoMark(NXOpen.Session.MarkVisibility.Invisible, "Result Measure")

        simSimulation1 = workSimPart.FindObject("Simulation")
        simSolution1 = simSimulation1.FindObject("Solution[Solution 1]")
        simResultReference1 = simSolution1.Find("Structural")
        resultManager1 = theSession.ResultManager
        solutionResult1 = resultManager1.FindObject("SolutionResult[" + self.fileName + "_fem_sim1.sim_Solution 1]")
        loadcase1 = solutionResult1.Find("Loadcase[1]")
        iteration1 = loadcase1.Find("Iteration[1]")
        ptype1 = NXOpen.CAE.Result.Type(NXOpen.CAE.Result.Quantity.Stress, NXOpen.CAE.Result.Location.ElementNodal,
                                        NXOpen.CAE.Result.Section.NotApplicable)
        resultMeasureResultOptions1 = simSimulation1.ResultMeasures.CreateNewResultOptions(simSolution1,
                                                                                           simResultReference1,
                                                                                           loadcase1, iteration1, False,
                                                                                           NXOpen.CAE.Iteration.Null,
                                                                                           ptype1,
                                                                                           NXOpen.CAE.Result.Component.VonMises)
        ...
        resultMeasure1 = simSimulation1.ResultMeasures.CreateResultMeasureNew(resultMeasureResultOptions1, None,
                                                                              "nodestress1")

        theSession.DeleteUndoMark(markId4, None)

        theSession.SetUndoMarkName(markId3, "Result Measure")

        markId5 = theSession.SetUndoMark(NXOpen.Session.MarkVisibility.Invisible, "Start")

        theSession.SetUndoMarkName(markId5, "Result Measure Dialog")

        # ----------------------------------------------
        #   Dialog Begin Result Measure
        # ----------------------------------------------
        markId6 = theSession.SetUndoMark(NXOpen.Session.MarkVisibility.Invisible, "Result Measure")

        theSession.DeleteUndoMark(markId6, None)

        markId7 = theSession.SetUndoMark(NXOpen.Session.MarkVisibility.Invisible, "Result Measure")

        theSession.UndoToMarkWithStatus(markId7, None)
        ...
        resultMeasure1 = simSimulation1.ResultMeasures.Find("NXOpen.CAE.ResultMeasure[nodestress1]")
